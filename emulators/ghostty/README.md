...
- Remote one‑liner:
```bash
wget -qO- https://raw.githubusercontent.com/xscriptor-colors/terminal/main/emulators/ghostty/uninstall.sh | bash
# or
curl -fsSL https://raw.githubusercontent.com/xscriptor-colors/terminal/main/emulators/ghostty/uninstall.sh | bash
```
- Local:
```bash
