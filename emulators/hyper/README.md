...
- One-liner:
```bash
wget -qO- https://raw.githubusercontent.com/xscriptor-colors/terminal/main/emulators/hyper/install.sh | bash
```
or
- Local install:
```bash
...
- Remote one‑liner:
```bash
wget -qO- https://raw.githubusercontent.com/xscriptor-colors/terminal/main/emulators/hyper/uninstall.sh | bash
# or
curl -fsSL https://raw.githubusercontent.com/xscriptor-colors/terminal/main/emulators/hyper/uninstall.sh | bash
```
- Local:
```bash
