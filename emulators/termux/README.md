...
```bash
wget -qO- https://raw.githubusercontent.com/xscriptor-colors/terminal/main/emulators/termux/install.sh | bash
# or
curl -fsSL https://raw.githubusercontent.com/xscriptor-colors/terminal/main/emulators/termux/install.sh | bash
```
