...
restore_config_file() {
  ...
  if grep -Eq '^theme[[:space:]]*=[[:space:]]*(xscriptor-theme\.ini|xscriptor-theme-light\.ini|x-retro\.ini|x-dark-candy\.ini|x-candy-pop\.ini|x-sense\.ini|x-summer-night\.ini|x-nord\.ini|x-nord-inverted\.ini|x-greyscale\.ini|x-greyscale-inverted\.ini|x-dark-colors\.ini|x-persecution\.ini)[[:space:]]*$' "$FILE"; then
