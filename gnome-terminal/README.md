...
- Remote one‑liner:
```bash
wget -qO- https://raw.githubusercontent.com/xscriptor/terminal/main/gnome-terminal/uninstall.sh | bash
# or
curl -fsSL https://raw.githubusercontent.com/xscriptor/terminal/main/gnome-terminal/uninstall.sh | bash
```
- Local:
```bash
